...
class KafkaListenerRelationTest(unittest.TestCase):
    ...
    def test_get_listeners(self,
        ...
        self.assertEqual(obj.get_unit_listener("", "", False, False), '{"test": {"bootstrap_server": "*BINDING*:9092", "endpoint": "test://*BINDING*:9092", "advertise": "test://*BINDING*:9092", "secprot": "PLAINTEXT", "SASL": {}, "plaintext_pwd": "", "cert_present": false, "sasl_present": false, "ts_path": "test", "ts_pwd": "test", "ks_path": "", "ks_pwd": "", "clientauth": false}, "connect": {"bootstrap_server": "*ADVERTISE*:9092", "endpoint": "connect://*ADVERTISE*:9092", "advertise": "connect://*ADVERTISE*:9092", "secprot": "SASL_SSL", "SASL": {"protocol": "GSSAPI", "kerberos-principal": "principal", "kerberos-protocol": "http"}, "plaintext_pwd": "", "cert_present": false, "sasl_present": true, "ts_path": "test", "ts_pwd": "test", "ks_path": "", "ks_pwd": "", "clientauth": false}}') # noqa